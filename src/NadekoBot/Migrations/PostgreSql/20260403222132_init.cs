        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    expressionoverrideenabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    waifuuserid = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    userid = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    snapshotbalance = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    userid = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    waifuuserid = table.Column<decimal>(type: "numeric(20,0)", nullable: false),
                    delegatedat = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lastdecaytime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    waifufeepercent = table.Column<int>(type: "integer", nullable: false),
                    price = table.Column<long>(type: "bigint", nullable: false),
                    manageruserid = table.Column<decimal>(type: "numeric(20,0)", nullable: true),
                    totalproduced = table.Column<long>(type: "bigint", nullable: false),
                    returnscap = table.Column<long>(type: "bigint", nullable: false),
                    ishubby = table.Column<bool>(type: "boolean", nullable: false),
