    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelSpotOverride", x => x.ChannelId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpressionOverrideEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LineUpUser", x => new { x.GuildId, x.ChannelId, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaifuCycle", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "WaifuCycleSnapshot",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ...
                    WaifuUserId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    UserId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    SnapshotBalance = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaifuCycleSnapshot", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    WaifuUserId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    DelegatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaifuFan", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    WaifuUserId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    GiftItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Count = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaifuGiftCount", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDecayTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    WaifuFeePercent = table.Column<int>(type: "INTEGER", nullable: false),
                    Price = table.Column<long>(type: "INTEGER", nullable: false),
                    ManagerUserId = table.Column<ulong>(type: "INTEGER", nullable: true),
                    TotalProduced = table.Column<long>(type: "INTEGER", nullable: false),
                    ReturnsCap = table.Column<long>(type: "INTEGER", nullable: false),
                    IsHubby = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaifuPendingPayout", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GuildId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    XpFormulaA = table.Column<int>(type: "INTEGER", nullable: false),
                    XpFormulaC = table.Column<int>(type: "INTEGER", nullable: false),
                    DateAdded = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LineUpUser_GuildId_ChannelId_DateAdded",
                table: "LineUpUser",
                columns: new[] { "GuildId", "ChannelId", "DateAdded" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaifuCycleSnapshot_CycleNumber_WaifuUserId",
                table: "WaifuCycleSnapshot",
                columns: new[] { "CycleNumber", "WaifuUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_WaifuCycleSnapshot_CycleNumber_WaifuUserId_UserId",
                table: "WaifuCycleSnapshot",
                columns: new[] { "CycleNumber", "WaifuUserId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WaifuFan_UserId",
                table: "WaifuFan",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WaifuFan_WaifuUserId",
                table: "WaifuFan",
                column: "WaifuUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WaifuGiftCount_WaifuUserId_GiftItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaifuPendingPayout_UserId",
                table: "WaifuPendingPayout",
                column: "UserId",
                unique: true);
